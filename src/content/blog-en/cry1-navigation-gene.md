...
2. **Magnetic sensing** — the "radical pair" hypothesis suggests cryptochrome forms radical pairs under light whose reactions are influenced by Earth&rsquo;s magnetic field

CRY1 genotypes (such as **CRY1-AG, CRY1-AT, CRY1-TT**) influence a pigeon&rsquo;s sensitivity to the geomagnetic field.

## Navigation Indicators

| Mechanism | Description |
|-----------|-------------|
| Geomagnetic | Direction via Earth&rsquo;s field (CRY1-related) |
